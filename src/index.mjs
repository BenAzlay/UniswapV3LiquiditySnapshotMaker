...
const getPositionDataFromNftId = async (nftId, defaultBlock = "latest") => {
  ...
  console.log(token0Address, 'position:', amount0);
  console.log(token1Address, 'position:', amount1);
  ...
  console.log(token0Address, 'unclaimed fees:', unclaimedFee0);
  console.log(token1Address, 'unclaimed fees:', unclaimedFee1);
}

getPositionDataFromNftId("556513", "latest");
